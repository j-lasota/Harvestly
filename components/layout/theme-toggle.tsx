...
export default function ThemeToggle() {
  ...
  }, [isContrast, setTheme, theme, mounted]);
  ...
  return (
    <button
      type="button"
      className="hover:bg-hover-background active:bg-active-background border-button-border-color cursor-pointer rounded-md border bg-white p-1.5 text-[#37352f] [transition:background_20ms_ease-in,_color_0.15s] dark:bg-[#191919] dark:text-[#ffffffcf]"
